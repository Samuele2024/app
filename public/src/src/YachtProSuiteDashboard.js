...
export default function YachtProSuiteDashboard() {
  ...
  return (
    <div style={{ padding: 20, maxWidth: 1000, margin: "auto" }}>
      ...
      <button onClick={handleExport} style={{ padding: "10px", marginRight: 10 }}>Export JSON Report</button>
      <button onClick={handleExportPDF} style={{ padding: "10px" }}>Export PDF Report</button>
    </div>
  );
}
